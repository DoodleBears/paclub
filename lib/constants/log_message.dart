// MARK: UserRepository 用到的 String
const String kAddUserFailed = 'add_user_fail';
const String kAddUserSuccess = 'add_user_succeed';
const String kUpdateUserlastLoginAtSuccess = 'update_user_last_login_succeed';
const String kUpdateUserlastLoginAtFailed = 'update_user_last_login_fail';
...
const String kUploadImageFailed = 'upload_image_fail';

const String kAddFriendFailed = 'add_friend_fail';
...
const String kUpdateUserInRoomSuccess = 'update_user_in_room_succeed';

const String kGetUserProfileFailed = 'get_user_profile_fail';
const String kGetUserProfileSuccess = 'get_user_profile_succeed';

const String kSearchUserFailed = 'search_user_fail';
const String kSearchUserSuccess = 'search_user_succeed';
...
const String kAddChatroomSuccess = 'add_chatroom_succeed';
const String kAddMessageFail = 'add_message_fail';
const String kAddMessageSuccess = 'add_message_succeed';

const String kNoMoreHistoryMessage = 'no_more_history_message';
